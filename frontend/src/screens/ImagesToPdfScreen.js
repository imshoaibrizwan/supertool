...
class ImagesToPdfScreen extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      images: [],
            ...
            <div className="imgtopdf_services">
              <Container style={{ padding: "10vh 0vh 4vh 0vh" }}>
                <Row>
                  ...
                  >
                    <BsFillHandThumbsUpFill size="40px" color="#06F28C" />
                    <h3 style={{ padding: "1vh 0vh" }}>
                      All Platforms Supported
                    </h3>
                    <p>
                      Our online PNG & JPG to PDF converter is browser-based and
                      functions independently from your OS. Because of this, you
                      can freely access our application using a Mac, Windows or
                      Linux.
                    </p>
                  </Col>
                  <Col
                    ...
                    style={{ textAlign: "center", marginTop: "1vh" }}
                  >
                    <BsFileEarmarkFill size="40px" color="#06F28C" />
                    <h3 style={{ padding: "1vh 0vh" }}>Compress PDF Size</h3>
                    <p>
                      You can also reduce the size of PDF document by using the
                      compression option before generating the PDF.
                    </p>
                  </Col>
                  <Col
                    lg="6"
                    ...
                    style={{ textAlign: "center", marginTop: "1vh" }}
                  >
                    <FaLock size="40px" color="#06F28C" />
                    <h3 style={{ padding: "1vh 0vh" }}>
                      Add Additional Documents
                    </h3>
                    <p>
                      After the initial file upload, there is also an option for
                      you to add more images, in case you wish to save and
                      combine multiple image files into one PDF with our online
                      service.
                    </p>
                  </Col>
                  ...
                  >
                    ...
                    <p>
                      ...
                      just this online PDF converter. It is cost and virus free.
                    </p>
                  </Col>
                </Row>
              </Container>
        ...
        <div style={{ display: "flex" }}>
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageMargin === None ? "#764AF1" : "rgb(240,240,240)",
          ...
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageMargin === Big ? "#764AF1" : "rgb(240,240,240)",
            ...
            style={{
              ...
              background:
                this.state.pageOrientation === Portrait
                  ...
                  : "rgb(240,240,240)",
              color:
                this.state.pageOrientation === Portrait ? "white" : "black",
              padding: "5px",
            }}
        ...
        <div style={{ display: "flex" }}>
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageSize === A4 ? "#764AF1" : "rgb(240,240,240)",
          ...
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageSize === Letter ? "#764AF1" : "rgb(240,240,240)",
          ...
          <div
            style={{
              ...
              textAlign: "center",
              background:
                this.state.pageSize === Fit ? "#764AF1" : "rgb(240,240,240)",
