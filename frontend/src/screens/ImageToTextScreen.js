...
const ImageToTextScreen = ({ showPage }) => {
          ...
          <div className="crop-div">
            <div className="container" style={{ marginBottom: "5vh" }}>
              <div style={{ paddingTop: "40px", textAlign: "center" }}>
                ...
                To extract text from image, we introduce a free online OCR
                (Optical Character Recognition) service. Upload a photo to the
                image to text converter online, click on convert and get your
                text file instantly.
              </div>
            </div>
                      ...
                      <Row>
                        ...
                        >
                          ...
                          <p style={{ textAlign: "left" }}>
                            ...
                            <b>1. </b>Upload an image to convert into text from
                            your device. <br />
                            <b>2. </b>Click the Convert to Text button to
                            initiate the conversion process.
                            <br />
                            <b>3. </b> Preview the converted text; copy it to
                            the clipboard with a single click or save the text
                        ...
                        >
                          ...
                          <p style={{ textAlign: "left" }}>
                            ...
                            during commute. With SUPERTOOL, you can convert your
                            images and photos to text with a single click. All
