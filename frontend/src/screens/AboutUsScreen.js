                  ...
                  <div className="col-lg-6 col-md-12">
                    <div className="about-content">
                      ...
                      <p className="paragraph">
                        ...
                        international education consultancy firms which
                        assisting overseas students
                      </p>
                      <p className="paragraph">
                        The head office of Eduplan is located in India which
                        helps all Indian students to get admission into
                        top-ranked universities from the United Kingdom, USA,
                        Australia, Canada,Germany and Sweden. At the same time,
                        we have a very strong relationship with our partner
                        ...
                        <ul className="ul icon-box-with-text style-01">
                          <li className="single-icon-box-with-text">
                            ...
                            <div className="content">
                              <p className="text">
                                Get life-time free access with one time payment
                                in our courses plan. Easy &amp; simple!
                              </p>
                            </div>
                          </li>
                          ...
                          <li className="single-icon-box-with-text style-03">
                            ...
                            <div className="content">
                              <p className="text">
                                ...
                                learning tasks that make students more
                                confident.
                              </p>
                            </div>
                          </li>
                            ...
                            <li className="single-icon-box-with-text">
                              ...
                              <div className="content">
                                ...
                                <p className="paragraph">
                                  ...
                                  consultancy and recruiting agency of the world
                                  by satisfying our clients’ in all aspects.
                                </p>
                              </div>
                            </li>
                            <li className="single-icon-box-with-text style-02">
                              ...
                              <div className="content">
                                ...
                                <p className="paragraph">
                                  BSB mission is to achieve excellence in
                                  business through excellent services and new
                                  scopes for world-class education by realizing
                                  dreams of our clients within their capacities.
                                </p>
                              </div>
                            </li>
                            <li className="single-icon-box-with-text style-03">
                              ...
                              <div className="content">
                                ...
                                <p className="paragraph">
                                  Create opportunities of abroad higher study
                                  and improve significantly family &amp;
                                  position and national development and to
                                  contribute to achieve Bangladesh as a middle
                                  income country.
                                </p>
                              </div>
                            </li>
