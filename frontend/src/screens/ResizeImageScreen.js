...
function ResizeImageScreen({ showPage }) {
          ...
          <div className="crop-div">
            <div className="container" style={{ marginBottom: "5vh" }}>
              <div style={{ paddingTop: "40px", textAlign: "center" }}>
                ...
                Image Resizer online allows you to resize image in seconds.
                Simply Upload your photo, set your required dimensions, click on
                the ‘Resize Image’ button, and download.
              </div>
            </div>
                      ...
                      <Row>
                        ...
                        >
                          ...
                          <p style={{ textAlign: "left" }}>
                            ...
                            troubles. All you need to do is follow the steps
                            given below: Access the online image resizer on
                            online SUPERTOOLS. Submit the picture you wish to
                            resize from your device or cloud storage. Set your
                            required dimensions. Hit the “Resize Image” button.
