...
const HashStringScreen = ({ showPage }) => {
          ...
          <div className="crop-div">
            <div className="container" style={{ marginBottom: "5vh" }}>
              <div style={{ paddingTop: "40px", textAlign: "center" }}>
                ...
                hash of a string. In order to use the tool, enter the text you
                want to convert to MD5 below and click on ‘Generate’ button.
              </div>
            </div>
                      ...
                      <Row>
                        ...
                        >
                          ...
                          <p style={{ textAlign: "left" }}>
                            ...
                            space provided, and our converter will compute your
                            data using a uniquely designed cryptographic hashing
                            algorithm for the hash, which uses a 32-hexadecimal
                            character arrangement. Once our hash generator
                            finished processing your request then you can copy
                            hashed string to the clipboard.
                          </p>
                        </Col>
                        <Col
                          lg="12"
                        ...
                        >
                          ...
                          <p style={{ textAlign: "left" }}>
                            ...
                            during commute. With SUPERTOOL, you can convert any
                            string to hashed string. All you need is a working
                            internet connection. With SUPERTOOL you can convert
                            any string to hashed string on the go!
                          </p>
                        </Col>
                      </Row>
                    </Container>
