...
const HtmlToPdfScreen = ({ showPage }) => {
                ...
                >
                  ...
                  <div style={{ paddingTop: "10vh", paddingBottom: "10vh" }}>
                    ...
                    <p style={{ fontSize: "15px" }}>
                      ...
                      <img src="assets/img/3dots.png" alt="3dots" /> and select
                      the <img src="assets/img/code.png" alt="code" /> icon.Then
                      write HTML code.
                    </p>
                    <span style={{ fontWeight: "bold", fontSize: "17px" }}>
                      Step 02:
                    ...
                    <p style={{ fontSize: "15px" }}>
                      Our tool will automatically start to convert the code to
                      PDF after clicking the "Generate PDF" button.
                    </p>
                    <span style={{ fontWeight: "bold", fontSize: "17px" }}>
                      Step 03:
                    </span>
